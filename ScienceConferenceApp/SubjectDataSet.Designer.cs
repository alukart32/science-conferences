...
namespace ScienceConferenceApp.SubjectDataSetTableAdapters {
    ...
    public partial class subjectsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[subjects] WHERE (([subjectId] = @Original_subjectId) AND ((@Is" +
                "Null_subject = 1 AND [subject] IS NULL) OR ([subject] = @Original_subject)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[subjects] ([subject]) VALUES (@subject);\r\nSELECT subjectId, su" +
                "bject FROM subjects WHERE (subjectId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[subjects] SET [subject] = @subject WHERE (([subjectId] = @Original_" +
                "subjectId) AND ((@IsNull_subject = 1 AND [subject] IS NULL) OR ([subject] = @Ori" +
                "ginal_subject)));\r\nSELECT subjectId, subject FROM subjects WHERE (subjectId = @s" +
                "ubjectId)";
        ...
        public virtual int Fill(SubjectDataSet.subjectsDataTable dataTable) {
        ...
        public virtual SubjectDataSet.subjectsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SubjectDataSet.subjectsDataTable dataTable = new SubjectDataSet.subjectsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SubjectDataSet.subjectsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_subjectId, string Original_subject) {
        ...
        public virtual int Update(string subject, int Original_subjectId, string Original_subject, int subjectId) {
            if ((subject == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string subject, int Original_subjectId, string Original_subject) {
            return this.Update(subject, Original_subjectId, Original_subject, Original_subjectId);
        }
    }
